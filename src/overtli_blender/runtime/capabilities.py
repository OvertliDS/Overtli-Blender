...
PROFILE_CAPABILITIES = {
    ...
    "remote_browser_safe": {"scene.read", "filesystem.project.read", "addon.inspect", "knowledge.read", "animation.read", "drivers.read", "rigging.read", "pose.read", "shots.read", "simulation.read", "motion.validate", "product.ux", "skills.read"},

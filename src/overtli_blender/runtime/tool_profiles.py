...
BUILTIN_TOOL_PROFILES: dict[str, ToolProfile] = {
    ...
    "chatgpt_browser_default": ToolProfile(
        "chatgpt_browser_default",
        "ChatGPT Browser Default",
        (
            "core",
            "scene_intelligence",
            "project_runtime",
        ...
        80,
        (
            "Use search_tools and workflow batches before exposing many atomic tools.",
            "Ask before scene mutation, filesystem writes, provider calls, or destructive operations.",

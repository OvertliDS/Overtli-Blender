...
def register_all_tools(mcp: Any, get_blender_connection, *, image_type: Any | None = None, visible_tool_names: set[str] | None = None) -> None:
    ...
    register_addon_interop_tools(mcp, get_blender_connection)
    register_error_catalog_tools(mcp, get_blender_connection)
    register_onboarding_tools(mcp, get_blender_connection)
    register_ux_status_tools(mcp, get_blender_connection)
